...
- [x] Explain the difference between `Relational Databases` and `SQL`.
        ...
        Relational databases is where data is stored and SQL is a method/tool used to query the data

- [x] Why do tables need a `primary key`?

        For look-up -- it's to easily identify a row -- you can use reference foreign key on other tables
...
- [x] What do we need in order to have a _many to many_ relationship between two tables.
        ...
        Intermediary table with foreign keys to each entity
